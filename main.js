...
const setBackground = () => {
    ...
    const imgs = [
        ...
        'newyork.jpg', 'osaka.jpg', 'paris.jpg', 'rome.jpeg', 'seoul.jpg'
    ];
...
loginName.addEventListener("keydown", (e) => {
    if (e.key === "Enter") {
        ...
        const headerGreeting = document.querySelector(".header__greeting");
        ...
        // 웹페이지 시작시 실행
        headerGreeting.innerText = `${localStorage.getItem("name")}님 안녕하세요!`;
        setTime();
        setDate();
...
// const todoAddBtn = document.querySelector(".todo__add__btn");
// todoAddBtn.addEventListener("click", () => {
//     const newTodo = document.querySelector(".todo__add__input").value;
